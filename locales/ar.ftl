...
# Payment
payment-upload-proof = يرجى رفع لقطة شاشة أو مستند كإثبات للدفع.
payment-invalid-file = لم أتمكن من فهم هذا الملف. يرجى إرسال صورة أو مستند، أو استخدم /cancel للإلغاء.
payment-cancelled = تم إلغاء عملية الدفع.
payment-select-months = اختر الشهر/الأشهر التي يجب تطبيق هذا الدفع عليها.
payment-confirm = ✅ تأكيد
payment-cancel = ✖️ إلغاء
payment-no-stocks = لا تملك أي أسهم في الدائرة النشطة.
payment-all-paid = لقد قدمت إثبات الدفع لجميع أشهر هذه الدائرة.
payment-success = ✅ تم حفظ إثبات الدفع الخاص بك. شكراً لك!
